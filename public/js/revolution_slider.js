jQuery(document).ready(function() {
	...
	jQuery(".fullwidthbanner ul , .fullscreenbanner ul").removeClass('invisible');
	...
	**/
	if(jQuery(".fullwidthbanner").length > 0) {
		...
		revapi = jQuery('.fullwidthbanner').revolution({
			...
			delay:9000,
			startwidth:1170,
			startheight: jQuery(".fullwidthbanner").attr('data-rev-height') || 550,
