         ...
         <div class="col-12 col-lg-3">
            <div class="card">
               ...
               <ul class="list-group list-group-flush">
                  <li class="list-group-item text-uppercase"><a href="{{route('news',10)}}">Работа КПК в период каникул, связанных с COVID-19 <br><span class="small text-muted">27.03.2020</span></a></li>
